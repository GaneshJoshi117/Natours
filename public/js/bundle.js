...
},{"axios":"../../node_modules/axios/index.js","/alert.js":"alert.js"}],"leaflet.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51MKTwDSEsbiyeA2cUAH8ozKi6pE8R7LuaY54g9ab34ZkA7NzQPjF4KsuavRqjqxAL1SZwvHFugm5MipXi25EoEzR00bxnGzdIQ'); //   console.log(tourId);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
            url: "https://natours-ganesh.onrender.com/bookings/checkout-session/".concat(tourId)
          });
        case 4:
